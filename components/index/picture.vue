    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          <h4>
            <img src="http://img4.imgtn.bdimg.com/it/u=2933273257,3396418405&fm=26&gp=0.jpg" alt="#" />
          </h4>
          <p class="m-life-login-name">Jay</p>
          <p>
    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-downapp">
          ...
          <p>App</p>
          <h4>
            <span class="red">周杰伦</span>
            <em class="gary">Jay</em>
          </h4>
        </div>
      </el-col>
    </el-row>
